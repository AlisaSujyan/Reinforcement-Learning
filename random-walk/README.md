...
## Problem Description
We simulate a random walk [environment]([should be added](https://github.com/AlisaSujyan/Reinforcement-Learning/blob/main/random-walk/book_images/Example_6_2_top.PNG)) with 7 states:
